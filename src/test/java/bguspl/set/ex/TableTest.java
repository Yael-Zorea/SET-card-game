...
class TableTest {
    ...
    void removeCard_slotIsFilled(){
        ...
        // removing the players tokens: env.ui.removeTokens(slot);
        // removing the card: env.ui.removeCard(slot);

    }

    @Test
    void isLegitRequest_Size2Array(){

        int[] slots = {0, 1};
        boolean result = table.isLegitRequest(slots);
